#+begin_export latex
Our working directory is \ty{tutorial} inside the \ty{o111h8} repo.
...
neighbor genomes listed, a total of 50, and store them in a file of
...
rather long names with redundant information, for example
\begin{verbatim}
